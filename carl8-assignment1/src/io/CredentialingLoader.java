...
public final class CredentialingLoader {
    ...
    public static String register(final String theUsername,
        ...
        //   the program crashes so I can make a pop up appear
        String result = "";
        ...
        //   the .ERROR_MSG_USER_EXISTS  message does not popup, it is jsut empty
       ...
       // System.out.println("Hola...2");
            ...
            System.out.println("I am inside the else...");
            //      files/users.txt
    ...
    private static boolean checkIfUserExists(final String theUsername) {
        ...
        //System.out.println("the usernamee : _" + theUsername + "_");
        //   GOTTA CREATE A FILTER IN CASE I ENCOUNTER A ""
        
       /* if("".equals(theUsername)) {
            System.out.println("Iamhere**************************");
            return true;
        }*/
        //  the below   files/users.txt
        try (Scanner input = new Scanner(Paths.get(R.Strings.IO_FILE_LOCATION
                                                   + R.Strings.IO_CREDENTIALS_FILE))) {
        ...
        //System.out.println("this is what checkIfUserExists found: " + found);
        return found;
    }
